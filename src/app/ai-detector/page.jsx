...
const SAMPLE_EMAILS = [
  {
    label: 'AI Phishing Email (ChatGPT)',
...
Customer Support Operations`
  ...
  {
    label: 'AI Corporate Marketing (LLM Embellished)',
        ...
        <main className="flex-1 p-6 lg:p-8 max-w-7xl mx-auto w-full space-y-8">
          ...
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purpleAccent/10 border border-purpleAccent/30 text-purpleAccent text-xs font-mono font-semibold">
              <Sparkles className="w-3.5 h-3.5" /> Phase 9 Synthetic Content Forensics
            </div>
            <h1 className="text-3xl font-extrabold font-heading text-textPrimary tracking-tight">
              AI-Generated Email Content Detector
            </h1>
            <p className="text-sm text-textSecondary max-w-3xl leading-relaxed">
              Forensic computational linguistics and stylometric engine detecting whether an incoming email was generated by an LLM (ChatGPT, Claude, Gemini, synthetic spear-phishing templates) or written by a human.
            </p>
          </div>
